...
# github-release repo tag branch "description" filename
# eg.
# export GITHUB_TOKEN=2345htrvdcse234rbfbgn345
# github-release SamarV-121/releases 1.0.2 master "Test release" test.zip
#
...
if [ "$5" ]; then
	...
	# Upload file
	GITHUB_ASSET="https://uploads.github.com/repos/$REPO/releases/$ID/assets?name=$FILE"
	echo "Uploading $5... "
